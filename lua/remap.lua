local keymaps = {
    ["n"] = {
        ...
        ["<A-a>"] = { function() require("harpoon"):list():select(1) end, { desc = "Navigate to pooned file 1" } },
        ["<A-s>"] = { function() require("harpoon"):list():select(2) end, { desc = "Navigate to pooned file 2" } },
        ["<A-d>"] = { function() require("harpoon"):list():select(3) end, { desc = "Navigate to pooned file 3" } },
        ["<A-f>"] = { function() require("harpoon"):list():select(4) end, { desc = "Navigate to pooned file 4" } },
        ["å"] = { function() require("harpoon"):list():select(1) end, { desc = "Navigate to pooned file 1" } },
        ["ß"] = { function() require("harpoon"):list():select(2) end, { desc = "Navigate to pooned file 2" } },
        ["∂"] = { function() require("harpoon"):list():select(3) end, { desc = "Navigate to pooned file 3" } },
        ["ƒ"] = { function() require("harpoon"):list():select(4) end, { desc = "Navigate to pooned file 4" } },
